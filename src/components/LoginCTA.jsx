    ...
    <section className="py-24 px-6 text-center">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-10 py-4 rounded-2xl bg-white text-black font-bold hover:scale-105 transition-transform">
            Get Started Now
          </button>
          <button className="px-10 py-4 rounded-2xl glass font-bold hover:bg-white/10 transition-all">
            Sign In
          </button>
        </div>
      </motion.div>
